...
public class Leads_TC22_DefaultView {
	...
	public static void login() {
		...
		//waitForVisibleElement(login,5);
		login.sendKeys("ani@anstar.com");
	...
	public static void clickTodayLeadDropDown() {
	...
	public static void clickOnleadTab2() throws InterruptedException {
		WebElement opty = driver.findElement(By.xpath("//a[text()='Leads']"));
		waitForVisibleElement(opty, 5);
		opty.click();
		//Thread.sleep(5000);
